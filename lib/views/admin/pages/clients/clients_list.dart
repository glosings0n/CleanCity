...
class _ClientsListState extends State<ClientsList> {
  Stream<QuerySnapshot>? clientssStream;

  @override
  void initState() {
    super.initState();
    clientssStream = ClientsServices.getClients();
  }
              ...
              ? FloatingActionButton.small(
                  onPressed: () {
                    showDialog(
                      context: context,
                      builder: (context) {
                        return PhoneAddClientForm(fromAdmin: true);
                      },
                    );
                  },
                  backgroundColor: Colors.grey.shade200,
                  ...
                  child: FloatingActionButton.extended(
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                          return AddClientForm(fromAdmin: true);
                        },
                      );
                    },
                    backgroundColor: Colors.grey.shade200,
